...
Welcome to `pypi-test-project` contributor's guide.
...
If you experience bugs or general issues with `pypi-test-project`, please have a look
...
You can help improve `pypi-test-project` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`pypi-test-project` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `pypi-test-project`'s files. While this mechanism can
...
```
conda create -n pypi-test-project python=3 six virtualenv pytest pytest-cov
conda activate pypi-test-project
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/pypi-test-project.git
   cd pypi-test-project
   ```
...
5. Install [pre-commit]:
   ...
   `pypi-test-project` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/pypi-test-project
[issue tracker]: https://github.com/<USERNAME>/pypi-test-project/issues
